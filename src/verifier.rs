...
pub trait Verifier {
    ...
    /// Box this Verifier into a `Box<dyn Verifier>`.
    fn boxed(self) -> Box<dyn Verifier>
    where
        Self: Sized + 'static,
    {
        Box::new(self)
