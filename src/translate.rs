...
impl Translate<VerificationError> for risc0_zkp_v2::verify::VerificationError {
    fn translate(self) -> VerificationError {
        ...
        match self {
            ...
            VerificationErrorV2::ControlVerificationError { control_id } => VerificationError::ControlVerificationError { control_id: control_id.translate() },
            VerificationErrorV2::ImageVerificationError => VerificationError::ImageVerificationError,
            VerificationErrorV2::MerkleQueryOutOfRange { idx, rows } => VerificationError::MerkleQueryOutOfRange { idx, rows },
            ...
            VerificationErrorV2::ClaimDigestMismatch { expected, received } => VerificationError::ClaimDigestMismatch { expected: expected.translate(), received: received.translate() },
            ...
            VerificationErrorV2::VerifierParametersMissing => VerificationError::VerifierParametersMissing,
            VerificationErrorV2::VerifierParametersMismatch { expected, received } => VerificationError::VerifierParametersMismatch { expected: expected.translate(), received: received.translate() },
            VerificationErrorV2::ProofSystemInfoMismatch { expected, received } => VerificationError::ProofSystemInfoMismatch { expected: expected.translate(), received: received.translate() },
            VerificationErrorV2::CircuitInfoMismatch { expected, received } => VerificationError::CircuitInfoMismatch { expected: expected.translate(), received: received.translate() },
            VerificationErrorV2::UnresolvedAssumption { digest } => VerificationError::UnresolvedAssumption { digest: digest.translate() },
